...
this.upload = function (url, params, callback) {
      ...
      formData.append("mediafile", self.blob, config.filename || 'recording.wav');
...
function visualize(stream) {
  ...
  function draw() {
    ...
    // clear the canvas
    //canvasCtx.fillStyle = config.visualizer.backcolor || '#222';
    ...
    canvasCtx.strokeStyle = config.visualizer.forecolor || '#888';
